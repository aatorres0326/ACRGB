                        ...
                        @if ($HCFUnderPro == null)
                            <thead>
                                <tr class="exclude-row">
                                    ...
                                    <th
                                        class="text-center {{ session()->get('leveid') === 'PRO' ? 'd-none' : '' }}{{ session()->get('leveid') === 'MB' ? 'd-none' : '' }}">
                                        Region</th>
                                    <th class="text-center disableSort">Hospital Code</th>
                        ...
                        @else
                                    ...
                                    @if (session()->get('leveid') == 'PHIC')
                                                <thead>
                                                    <tr class="exclude-row">
                                                        <th class="disableSort">Facility</th>
                                                        <th class="text-center disableSort">Level</th>
                                                        <th class="text-center disableSort">Address</th>
                                                                                        ...
                                                                                        @else
                                                                                                    @if ($facility['type'] == "APEX")
                                                                                                                @php
                                                                                                                    ...
                                                                                                                    $apexpro = $facility['proid'];

                                                                                                                    $parsedApexpro = json_decode($apexpro);

                                                                                                                @endphp
                                                                                                    @endif
                                                                                                    @if ($facility['type'] == "APEX")
                                                                                                        <td class="text-center">{{ $parsedApexpro[0] }}</td>
                                                                                                    @else
