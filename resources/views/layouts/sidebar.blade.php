<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item {{ session()->get('leveid') === 'MB' ? 'd-none' : '' }}{{ (request()->is('dashboard')) ? 'active' : '' }} {{ session()->get('leveid') === 'PRO' ? 'd-none' : '' }} {{ session()->get('leveid') === 'ADMIN' ? 'd-none' : '' }}">
    ...
    <li class="nav-item  {{ session()->get('leveid') === 'MB' ? 'd-none' : '' }}{{ (request()->is('budgetmanagement')) ? 'active' : '' }} {{ session()->get('leveid') === 'STAFF' ? 'd-none' : '' }} {{ session()->get('leveid') === 'ADMIN' ? 'd-none' : '' }} {{ (request()->is('viewhcfbudget')) ? 'active' : '' }} {{ session()->get('leveid') === 'PRO' ? 'd-none' : '' }}">
    ...
    {{ session()->get('leveid') === 'STAFF' ? 'd-none' : '' }}
    {{ session()->get('leveid') === 'PRO' ? 'd-none' : '' }}" id="accordion">
