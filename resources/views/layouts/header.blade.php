        ...
        <div class="card-header">
            ...
            <span class="text-uppercase font-weight-bold text-secondary" style="font-size:14px;">
                <a class="btn btn-primary btn-sm" href="{{ url()->previous() }}"><i
                        class="fa fa-fw fa-arrow-left mr-1"></i></a>&nbsp;
                ...
                {{ (request()->is('Contracts/NewContract')) ? '  Contracts / New FACILITY/HCPN Contract' : '' }}
                {{ (request()->is('ContractHistory')) ? '  Contract History' : '' }}
                {{ (request()->is('Contracts/NewAPEXContract')) ? '  Contracts / New APEX Contract' : '' }}
