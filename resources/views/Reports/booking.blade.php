                        ...
                        <div class="mt-2">
                            <button class="btn-sm btn btn-outline-success mr-1"
                                ...
                                class="btn-sm btn btn-outline-warning mr-1"><i
                                    ...
                                    @if($Claims != null)
                                    <button
                                class="btn-sm btn btn-outline-danger" data-toggle="modal" data-target="#confirm-book"><i class="fas fa-fw fa-lock"></i>Lock Data</button>
                                @else    
                                    <a
                                    class="btn-sm btn btn-outline-danger disabled"><i class="fas fa-fw fa-lock"></i>Lock Data</a>
                                @endif
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('BookData') }}" method="POST">
                            @csrf
                                    <input type="text" name="code" class="form-control d-none"
                                        value="{{$ConNumber}}" readonly required>
                           ...
                           <div class="form-group col-md">
                                ...
                                <div class="form-group col-md">
                                    ...
                                    <input type="text" placeholder="Please Input Booking Number" name="booknum" class="form-control" required>
                                </div>
                            </div>
...
<script>
    function setControlNumberAndRedirect() {
        ...
        window.location.href = "/Reports/Booking?controlNumber=" + controlNumber + "&conID=" + conID + "&hcfHCPN=" + hcfHCPN+ "&transCode=" + transCode;
    }
</script>
