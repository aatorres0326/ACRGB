...
<div class="container-fluid">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-5">
                ...
                <select id="userlevel" class="form-control">
                  <option value="hlevel">User</option>
                  <option value="alevel">Admin</option>
                  <option value="slevel">Super Admin</option>
                </select>
              </div>
            </div>
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <div class="table-responsive-sm" style="overflow-y:auto; max-height: 520px; margin-top:25px; margin-bottom: 10px;"
        id="content">
        <div style="position:absolute; top:13px; right:470px">
          <a class="btn btn-link btn-sm" data-toggle="modal" data-target="#add-user" text-decoration: none;"><i
              class="fas fa-plus fa-sm text-info-40"></i> Add User
          </a>
        </div>
