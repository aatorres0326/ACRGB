            ...
            reader.onload = function (e) {
                ...
                jsonSheet.forEach((row, index) => {
                    ...
                    if (!isEmptyRow) {
                        ...
                        newRow += `<td class="d-none">{{ date('m-d-Y') }}</td><td class="d-none">{{ session()->get('userid') }}</td><td class="text-center"><button class="btn btn-sm btn-outline-danger">Remove</button></td>`;
                        newRow += "</tr>";
