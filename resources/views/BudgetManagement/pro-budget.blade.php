                    ...
                    <form action="{{ route('AddContract') }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md">
                                ...
                                <input type="text" name="transcode" class="form-control" placeholder="Reference #"
                                    double autocomplete="off" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <select name="mb" id="selectedhcf" class="form-control" required>
                                    ...
                                    @foreach ($RegionalOffices as $pro)
                                        <option value="{{ $pro['procode']}}" data-base-amount="{{ $pro['conamount'] }}">
                                            {{ $pro['proname']}}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md">
                                ...
                                <input type="text" name="amount" class="form-control" oninput="formatNumber(this)"
                                    placeholder="Enter amount" double required autocomplete="off">
                            </div>
                        </div>
