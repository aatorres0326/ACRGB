...
<script>
    function ViewTranches(conid, hcpn, amount, transcode, percentage) {
        var hcpnObject = JSON.parse(hcpn);
        var mbname = hcpnObject.mbname;
        var controlnumber = hcpnObject.controlnumber;
        ...
        window.location.href = "/hcpnassets?conid=" + conid + "&hcpn=" + mbname + "&amount=" + amount + "&transcode=" + transcode + "&controlnumber=" + controlnumber + "&percentage=" + percentage;
    }
</script>
<script>
