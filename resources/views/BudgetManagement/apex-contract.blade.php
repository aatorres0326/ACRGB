    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
                            ...
                            <tr>
                                <thead>
                                    <tr class="exclude-row">
                                        ...
                                        <th class="text-center disableSort" id="max-width-column" data-sortable="true">
                                            APEX Facility</th>
            ...
            $hcf = json_decode($contract['hcfid'], true);
                                                                                            ...
                                                                                            <td><strong>&#8369;</strong> &nbsp;{{ number_format((double) $contract['amount'], 2) }}
                                                                                            </td>
                    ...
                    <form action="{{ route('EditHCPNContract') }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <input name="e_controlnumber" id="e_controlnumber" class="form-control d-none">
