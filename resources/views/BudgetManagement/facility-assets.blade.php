                ...
                <div class="modal-content">
                    <div class="modal-header bg-light">
                        <span class="modal-title">Release Tranche to <span
                                class="text-info font-weight-bold">{{ $SelectedHCF }}</span></span>
                            ...
                            <div id="prevbal" style="display:none">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="previous_balance"
                                                    value="{{ $PreviousBalance['conbalance'] }}" id="previous-bal"
                                                    class="form-control" double readonly>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="e_amount">Previous Balance</label>
                                            <input type="text" name="previous_balance" value="0" id="previous-bal"
                                                class="form-control" double readonly>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md">
                                    ...
                                    <input type="text" name="contract_amount" id="contract"
                                        value="{{ $SelectedAmount }}" class="form-control d-none" double readonly>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-5">
                                    <label for="tranch">Tranche</label>
                                    <select name="tranch" id="tranch" class="form-control" onchange="updatePercentage()"
                                        required>
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <input type="text" name="tranch_amount" id="tranch_amount" value=""
                                        class="form-control" oninput="formatNumber(this)" double required readonly>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md">
