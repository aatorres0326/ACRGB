                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <strong>
                                    <p class="card-text">UTILIZED : &nbsp;<span id="utilizedamount"
                                        ...
                                        {{  number_format((double) $SelectedPercent, 1)}}%</p>
                                </strong>
                            </div>
                        </div>
                    </div>
            ...
            break;
                                                            ...
                                                            @if ($releaseTranch)
                                                                ...
                                                                <a class="btn btn-sm btn-outline-primary disabled" data-toggle="modal"
                                                                    data-target="#release-tranch" style="float:right;">Release Tranch</a>
                                                            @else

                                                                <button class="btn-sm btn-outline-primary" data-toggle="modal" data-target="#release-tranch"
                                                                    style="float:right;">Release Tranch</button>
                                                            @endif
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-md">
                        <div class="modal-content">
                            <div class="modal-header bg-light">
                                <span class="modal-title">Release Tranche to <span class="text-info font-weight-bold">{{ $SelectedHCPN }}</span></span>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="previous_balance" value="{{ $PreviousBalance['conbalance'] }}"
    ...
    $displayedTranchTypes = [];
                                                                                                                        ...
                                                                                                                        @if (!($hasFirstTranch && str_contains($tranch['tranchtype'], '1ST')))
                                                                                                                            ...
                                                                                                                            @if (!($hasSecondTranch && str_contains($tranch['tranchtype'], '2ND')))
                                                                                                                                ...
                                                                                                                                <option value="{{ $tranch['tranchid'] }}"
                                                                                                                                    ...
                                                                                                                                    {{ $tranch['tranchtype'] }} TRANCHE</option>
                                                                                                                            @endif
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <input type="text" name="tranch_amount" id="tranch_amount" value=""
                                                        class="form-control" oninput="formatNumber(this)" double
                                                        required readonly>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md">
                                                    ...
                                                    <input type="text" name="released_amount" id="released_amount"
                                                        value="" class="form-control" double readonly>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md">
