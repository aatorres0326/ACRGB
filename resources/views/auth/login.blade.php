  ...
  <div class="container"> <!-- Outer Row -->
    ...
    <!-- Nested Row within Card Body -->
      ...
      <!--div class="col-lg-6 d-none d-lg-block bg-login-image"></div-->
              <div class="col-lg-6">
                <center><img class="mb-4 p-5" src="{{ asset('admin_assets/img/ACR_GBlogo.png') }}" alt="" width="350"></center>
              </div>
              <div class="col-lg-6"> 
                <div class="p-5"> 
                    ...
                    <div class="form-group">
                      <input name="email" type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Username">
                    </div>
                    <div class="form-group">
