        ...
        if (options !== null) {
            ...
            **/
            ...
            if (
                ...
                // div num rows
                var numrowsDiv =
                    '<div style="position:absolute; top: 3px; left:8px;"><div id="for_numrows" class="for_numrows" style="display: inline-block;"><label for="numrows">' +
                    translate(voc_show_rows) +
                    ' </label><select id="numrows" class="btn btn-sm"></select> Rows</div></div>';
        ...
        function appendPageControllers(nPages) {
            ...
            $("#pagesControllers").append(
                $("<button>", {
                    value: "first",
                    text: "First",
                    class: "pagecontroller pagecontroller-f btn btn-sm",
                })
            );
            // Previous
            $("#pagesControllers").append(
                $("<button>", {
                    value: "prev",
                    text: "Prev",
                    class: "pagecontroller pagecontroller-p btn btn-sm",
                })
            );
            // Numbers
            for (i = 1; i <= nPages; i++) {
                $("#pagesControllers").append(
                    $("<button>", {
                        value: i,
                        text: i,
                        class: "pagecontroller pagecontroller-num btn btn-sm",
                    })
                );
            }
            // Next
            $("#pagesControllers").append(
                $("<button>", {
                    value: "next",
                    text: "Next",
                    class: "pagecontroller pagecontroller-n btn btn-sm",
                })
            );
            // Last
            $("#pagesControllers").append(
                $("<button>", {
                    value: "last",
                    text: "Last",
                    class: "pagecontroller pagecontroller-l btn btn-sm",
                })
            );
        }
